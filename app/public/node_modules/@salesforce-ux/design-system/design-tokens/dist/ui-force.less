...
/* Hot Orange 20 */
@palette-hot-orange-20: rgb(84, 29, 1);
/* Hot Orange 10 */
...
/* Indigo 20 */
@palette-indigo-20: rgb(38, 15, 143);
/* Indigo 10 */
...
/* Purple 80 */
@palette-purple-80: rgb(215, 143, 245);
/* Purple 70 */
...
/* Violet 20 */
@palette-violet-20: rgb(82, 0, 102);
/* Violet 10 */
...
@color-background-selection: rgb(238, 244, 255);
...
@color-background-reminder: rgb(250, 250, 249);
...
@button-color-border-primary: rgb(243, 242, 242);
...
@color-background-button-default-focus: rgb(250, 250, 249);
...
@color-background-button-default-hover: rgb(250, 250, 249);
...
@color-background-button-icon-focus: rgb(243, 242, 242);
@button-color-background-secondary: rgba(255, 255, 255, 0.8);
/* Brandable primary button - disabled state */
@color-background-button-brand-disabled: rgb(243, 242, 242);
...
@color-background-button-icon-hover: rgb(243, 242, 242);
...
@color-background-button-icon-active: rgb(243, 242, 242);
...
@color-background-button-default-active: rgb(243, 242, 242);
...
@color-border-context-bar-theme-default-hover: rgb(38, 15, 143);
...
@color-background-path-complete: rgb(69, 198, 90);
